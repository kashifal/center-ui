...
const Header = () => {
  ...
  return (
    <Fragment>
      <div className='h-16    bg-white w-[100%] md:w-[100%] lg:w-[80%] shadow-sm fixed' style={{zIndex:'100'}}>
        <div className='h-full w-full px-6  flex items-center'>
          <div className='flex-1  h-full flex items-center justify-between'>
            ...
            <div className='w-96 h-full flex items-center justify-end gap-6'>
              <a
                href='https://www.figma.com/file/brqhRQR4ZaWisj8wqq6Wlv/center-ui-team-library?t=A9vWwMM9j61b48Qm-0'
                className=''
              >
                <svg
                  width='20'
